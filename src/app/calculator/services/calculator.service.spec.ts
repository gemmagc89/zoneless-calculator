...
describe('CalculatorService', () => {
  ...
  it('should be created with defaults value', () => {
  ...
  it('should calculate result correctly for multiplication using "x"', () => {
    service.constructNumber('5');
  ...
  it('should calculate result correctly for division using "÷"', () => {
    service.constructNumber('1');
    service.constructNumber('0');
    service.constructNumber('÷');
    service.constructNumber('2');
  ...
  it('should do nothing if receives an invalid input', () => {
